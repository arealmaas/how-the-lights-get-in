...
- **Compare overlapping picks**: from *My picks*, *My festival*, or a picked event’s clash notice, compare competing sessions by their central question, briefing context, programme description, speaker profiles, topics, personal notes and ticket requirements. An overlap timeline includes partial clashes and labels all end times as estimates. *Choose this event* removes only picks that directly overlap that choice, preserving later events in a chain; *Undo choice* restores the affected picks. Options stay available while comparing, and full event or speaker details return to the same comparison.
